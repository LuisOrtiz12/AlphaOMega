...
class ClienteUsoActivate extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->line("Le notificamos por medio de la Escuela de Biodanza SRT Puembo que su cuenta ha sido nuevamente activada")
        ->line("Detalles de la notificacion:")
        ->line("User role: $this->role_name")
        ->line("Observacion: $this->observacion")
        ->line("Si visualiza que que su cuenta no ha sido restaurada. Por favor contactenos:")
        ->line("Email de Administrador: $this->email_admin")
        ->line("Contacto: $this->number_admin")
        ->line("La aplicacion AlphaO agradece su atencion....");
    }
